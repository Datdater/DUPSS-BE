...
public class UpdateCourseRegistrationCommandHandler(IUnitOfWork unitOfWork)
    : ICommandHandler<UpdateCourseRegistrationCommand>
{
    ...
    {
        var courseRegistration = await unitOfWork
        ...
        if (courseRegistration == null)
            return Result.Failure(
                new Error(
                    ...
                    "The specified course registration was not found."
                )
            );
